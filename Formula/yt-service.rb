class YtService < Formula
  include Language::Python::Virtualenv

  desc "Yt-dlp web service"
  homepage "https://github.com/hyxf/"
  url "https://files.pythonhosted.org/packages/cf/2f/8c29cc0fec9fbff56e5fed4fe9345ab22ed72d5e3ae9539176587d7cebb3/yt_service-0.0.5.tar.gz"
  sha256 "4dbafa8330e8a9bd82fa15235366ecf20ffb790a4b741bfe04bfef148bf99ef7"
  license "MIT"
  ...
  test do
    ...
    # software. Run the test with `brew test yt-service`. Options passed
    # to `brew install` such as `--HEAD` also need to be provided to `brew test`.
    #
    # The installed folder is not in the path, so use the entire path to any
    # executables being tested: `system "#{bin}/program", "do", "something"`.
    system "#{bin}/yt-service", "--help"
  end
end
